...
function init() {
	var e = {
			zoom: 16,
			center: new google.maps.LatLng(34.434, -118.497),
			disableDefaultUI: !0,
			scrollwheel: !0,
			draggable: !0,
			styles: [
				{
					...
					stylers: [{ color: 'lavender' }, { lightness: 17 }]
				},
				{
					featureType: 'landscape',
					elementType: 'geometry',
					stylers: [{ color: 'lavender' }, { lightness: 40 }]
				},
				{
					featureType: 'road.highway',
					elementType: 'geometry.fill',
					stylers: [{ color: 'teal' }, { lightness: 17 }]
				},
				{
					featureType: 'road.highway',
					elementType: 'geometry.stroke',
					stylers: [{ color: 'teal' }, { lightness: 29 }, { weight: 0.2 }]
				},
				{
					featureType: 'road.arterial',
					elementType: 'geometry',
					stylers: [{ color: 'teal' }, { lightness: 18 }]
				},
				{
					featureType: 'road.local',
					elementType: 'geometry',
					stylers: [{ color: 'teal' }, { lightness: 16 }]
				},
				{
					featureType: 'poi',
					elementType: 'geometry',
					stylers: [{ color: 'teal' }, { lightness: 21 }]
				},
				{
					elementType: 'labels.text.stroke',
					stylers: [{ visibility: 'on' }, { color: 'teal' }, { lightness: 16 }]
				},
				{
				...
				{ elementType: 'labels.icon', stylers: [{ visibility: 'off' }] },
				{
					...
					elementType: 'geometry.fill',
					stylers: [{ color: 'teal' }, { lightness: 20 }]
				}
			]
		},
		t = document.getElementById('map');
	map = new google.maps.Map(t, e);
	var a = 'img/img/portal.png',
		l = new google.maps.LatLng(34.434, -118.497),
		o = (new google.maps.Marker({ position: l, map: map, icon: a }),
...
function initializeClock(e, t) {
	function a() {
		...
		(o.innerHTML = ('0' + e.days).slice(-3)),
			(n.innerHTML = ('0' + e.hours).slice(-2)),
			(s.innerHTML = ('0' + e.minutes).slice(-2)),
			(r.innerHTML = ('0' + e.seconds).slice(-2)),
			e.total <= 0 && clearInterval(i);
	}
	var l = document.getElementById(e),
		o = l.querySelector('.days'),
		n = l.querySelector('.hours'),
		s = l.querySelector('.minutes'),
		r = l.querySelector('.seconds');
	a();
...
getTimeRemaining(deadline), initializeClock('clockdiv', deadline);
