...
function init() {
	...
	var parkingCoordinates3 = [
		{ lat: 34.433061, lng: -118.498109 },
		{ lat: 34.432492, lng: -118.49706 }
	];
	...
	var parkingPath3 = new google.maps.Polyline({
		path: parkingCoordinates3,
		geodesic: true,
		strokeColor: '#FF0000',
		strokeOpacity: 0.5,
		strokeWeight: 15
...
$(document).ready(function() {
	$('#contact_form')
		...
		.on('success.form.bv', function(e) {
			...
			emailjs
				.send('char_m_anon_gmail_com', 'template_1', {
					to_email: email,
					to_name: firstName
				})
				.then(
